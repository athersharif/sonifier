...
exports.resetSonifier = exports["default"] = void 0;
...
var resetSonifier = function resetSonifier(Tone) {
  var oscillations = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
  Tone.Transport.stop();
...
exports.resetSonifier = resetSonifier;
...
var sonifier = function sonifier(Tone, data) {
  ...
  var sortedData = _toConsumableArray(data.y).sort(function (a, b) {
    return a - b;
  });

  var maxValue = sortedData[sortedData.length - 1];
  var minValue = sortedData[0];
  settings = _get__("defaultsDeep")(settings, _get__("defaultSettings"));
  var oscillations = [];
  var start = 0;
  var stop = start + settings.oscillator.interval;
...
var _typeOfOriginalExport = _typeof(sonifier);

function addNonEnumerableProperty(name, value) {
  Object.defineProperty(sonifier, name, {
    value: value,
    enumerable: false,
    configurable: true
  });
...
if ((_typeOfOriginalExport === 'object' || _typeOfOriginalExport === 'function') && Object.isExtensible(sonifier)) {
